...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('edit_qty', ['as' => 'edit_qty', 'uses' => 'App\Http\Controllers\TransactionController@edit_qty']);
	Route::post('delete_', ['as' => 'delete_', 'uses' => 'App\Http\Controllers\TransactionController@delete']);
	Route::post('confirm', ['as' => 'confirm', 'uses' => 'App\Http\Controllers\TransactionController@confirm']);
	Route::get('report', ['as' => 'report', 'uses' => 'App\Http\Controllers\TransactionController@report']);
